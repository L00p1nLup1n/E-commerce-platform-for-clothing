		...
		<div class="owl-carousel owl-carousel3">
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper uniform wrapper">
						<img src="${URL}assets/frontend/pages/img/products/rcb.jpg"
							class="img-responsive" alt="RCB pump">
			...
			<div>
				<div class="product-item">
					<div class="pi-img-wrapper uniform-wrapper">
						<img src="${URL}assets/frontend/pages/img/products/liqui.jpg"
							class="img-responsive" alt="Liqui">
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-3">
				<div class="product-main-image">
					<img src="${URL}assets/frontend/pages/img/products/gsport.jpg"
						alt="YSS G-Sport" class="img-responsive">
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-9">
				...
				<div class="description">
					<p>The YSS G-Sport Suspension is engineered for performance and
				...
				<div class="product-page-cart">
					...
					<a href="${pageContext.request.contextPath }/login"
						class="btn btn-primary" type="submit">Add to cart</a> <a
						href="shop-item.html" class="btn btn-default">More details</a>
				</div>
			</div>
